...
atoms = read('/home/christian/vsc/energy_decomposition/restart_routines/test_systems/H2/blank_test/geometry.in')
cell = atoms.cell

filename = '/home/christian/vsc/energy_decomposition/restart_routines/test_systems/H2/blank_test/output.aimsrestart'
...
eigenvalues, psi, occ, orb_pos = aims_read_eigenvalues_and_coefficients(fermi_level, '/home/christian/vsc/energy_decomposition/restart_routines/test_systems/H2/blank_test', spin=False, debug=False)
...
H, S = aims_read_HS('/home/christian/vsc/energy_decomposition/restart_routines/test_systems/H2/blank_test',spin=False)
...
#Read fortran restart files and recreate them in a format which aims can read and use!!
# Be careful -> the eigenvalues written to the restart files have to be in Hartree!!
# So there is a factor 27.211
    
# Code to read and write out the aims generated restart files..
# This section is meant to test the Fortran IO...
...
for ii in range(N_k_control):
    path = '/home/christian/Documents/Code_playground/'
    if reproduce:
        if ii<10:
            num = '00'+str(ii)
        else:
